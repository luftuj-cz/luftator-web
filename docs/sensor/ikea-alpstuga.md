...
![Ikea ALPSTUGA - čidlo CO2](./img/ikea-alpstuga.png)

## Připojení do Home Assistantu

- Zkontrolute, zda máte potřebný hardware a že jste provedli všechny kroky potřebné pro [instalaci Matter over Thread](/docs/home-assistant#instalace-matter-over-thread).
- V mobilní aplikaci Home Assistant Companion na mobilním telefonu klikněte v Menu na Matter | Přidat zařízení.
